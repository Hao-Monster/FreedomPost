...
func TestIsAllowedAttachmentURL(t *testing.T) {
	cases := []struct {
		...
		{"sibling host prefix rejected", "https://pub.r2.dev.evil.example/fp/file.jpg", []string{"https://pub.r2.dev"}, false},
		{"sibling path prefix rejected", "https://pub.r2.dev/fp-evil/file.jpg", []string{"https://pub.r2.dev/fp"}, false},
		{"local sibling path rejected", "/api/uploads-evil/file.jpg", nil, false},
